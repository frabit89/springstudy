...
public class MyController4 {
  ...
  // method=RequestMethod.GET : GET방식이 기본이기 때문에 생략 가능
  // value만 남은 경우 value= 부분은 생략 가능
  ...
  public String list(Model model) {
    ...
    // jsp의 경로와 이름, views폴더에 만들어야 함. /WEB-INF/views/blog/list.jsp 를 의미
    return "blog/list";
  }
 ...
 // @RequestMapping(value="/blog/add.do", method=RequestMethod.POST)
  ...
  @RequestMapping(value="/blog/add.do", method=RequestMethod.POST)
  public String add2(@ModelAttribute("blog") BlogDto blog) {   // @ModelAttribute : 커맨드 객체가 Model에 저장되는 이름을 지정할 때 사용한다.
